...
# From https://raw.githubusercontent.com/webworxshop/micropython-room-sensor/master/hassnode.py
...
class Sensor(BaseEntity):
    ...
    def __init__(self, mqtt, name, unit_of_measurement, object_id, node_id=None, discovery_prefix="homeassistant", value_template=None):
        ...
        self.config = {"name": name, "unit_of_measurement": unit_of_measurement}
        if value_template:
